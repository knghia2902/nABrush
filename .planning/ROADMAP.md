...
- [x] 03-02-PLAN.md — Line/arrow and rectangle/ellipse geometry tools with preview and fill styles

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-03-PLAN.md — Text draft lifecycle, canonical hit-testing and single-item eraser
...
- [x] 03-05-PLAN.md — Gap closure: shape fill controls and per-tool style assertions

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 03-06-PLAN.md — Gap closure: macOS pointer-up path and cross-platform native smoke
