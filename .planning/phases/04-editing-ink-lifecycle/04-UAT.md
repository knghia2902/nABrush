...
number: 3
name: Thiết lập riêng theo công cụ sau Undo/Redo
expected: |
  Màu sắc, độ dày, độ mờ, màu tô và cỡ chữ vẫn gắn với đúng công cụ sau khi chuyển đổi giữa các công cụ và khôi phục lịch sử.
